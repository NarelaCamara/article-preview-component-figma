      ...
      >
        <div className="grid grid-cols-5 grid-rows-1 gap-2 place-items-center md:place-items-start">
          ...
          <div className="col-start-5">
            {/**Desktop y tablet */}
            <div
              className={` px-[38px] py-[16px]  bg-[#48556A] absolute top-[50vh] right-[22vw]   rounded-xl hidden ${
                share ? " md:block " : "  "
              }  min-w-[248px]`}
            >
              <div className="grid grid-cols-5 grid-rows-1 gap-1 place-items-center ">
                <h4 className={`text-[#9DAEC2] text-sm font-[Manrope]`}>
                  SHARE
                </h4>
              ...
              <div
                className=" absolute top-[8.2vh] right-[9.8vw] w-0 h-0 
    border-l-[12px] border-l-transparent 
    border-r-[12px] border-r-transparent 
    border-t-[12px] border-t-[#0546af]"
              ></div>
            </div>
            {/**Desktop y tablet */}
            <button
